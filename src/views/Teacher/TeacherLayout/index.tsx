...
const TeacherLayout: React.FC<ITeacherLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="fixed inset-0 z-[1001] overflow-hidden md:flex">
      ...
      <AppSidebar variant="teacher" onClose={() => setIsSidebarOpen(false)} />

      {/* Page content — slides right on mobile to reveal sidebar */}
      <div
